...
def create_model(args, model_name, output_dim):
    ...
    elif model_name == "resnet18_gn" or args.dataset == "fed_cifar100":
...
if __name__ == "__main__":
    ...
    wandb.init(
        project="fedml",
        name="FedAVG-r" + str(args.comm_round) + "-e" + str(args.epochs) + "-lr" + str(args.lr)+ "-t" + str(args.client_num_in_total)+ "-d" + str(args.dataset)+"-lrdecay",
        config=args
    )
